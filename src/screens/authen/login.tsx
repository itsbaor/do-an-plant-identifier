...
const styles = StyleSheet.create({
  ...
  checkbox: { width: 18, height: 18, borderRadius: 100, borderWidth: 1, borderColor: "#CBD5E1", marginRight: 8 },
  checkboxChecked: { backgroundColor: "#13d336ff", borderColor: "#0f172a" },
  submit: { marginTop: 8 },
